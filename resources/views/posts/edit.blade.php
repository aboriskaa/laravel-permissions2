                ...
                <div>
                    ...
                    <input id="title" type="text" name="title"
                        class="block w-full py-3 px-3 mt-2
                            ...
                            focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md" value="{{ $post->title }}"/>
                    @error('title')
                ...
                <div>
                    ...
                    <input id="body" type="text" name="body"
                        class="block w-full py-3 px-3 mt-2
                            text-gray-800 appearance-none
                            border-2 border-gray-100
                            focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md" value="{{ $post->body }}"/>
                    @error('body')
                        <span class="text-sm text-red-400">{{ $message }}</span>
                    @enderror
                </div>
